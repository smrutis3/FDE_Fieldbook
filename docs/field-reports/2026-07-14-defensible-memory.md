...
- **Refused:** Electron coworker shell, Gmail/Slack ambient sync, PostHog, background agents writing into the record. FDE Fieldbook compounds as fast as the FDE debriefs — make debrief cheap, keep the NDA moat.
