...
| "Log 2 hours on Garvey" / "week budget is 4h" | `fde log time 2h <note>` / `fde log budget 4h` (ISO week). Never invent hours. |
| "Who is starved?" / "who did I ignore?" | `fde status --all` — trust first, then pulse, then hours. Pulse is last customer touch + your hours, not product adoption. |
